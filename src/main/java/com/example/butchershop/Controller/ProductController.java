...
import com.example.butchershop.Service.ProductService;
import com.example.butchershop.Validation.ProductValidator;
...
public class ProductController {
    ...
    public String getProduct(Model model, @Param("keyword")String keyword){
        List<Product> products=productService.findAllProducts(keyword);
